...
import Data_representation as data_collector
import Load as disk_helper
import numpy as np
from Model import Graph2SeqNN
import tensorflow as tf
import Construct as helpers
import datetime
import Decoder
...
if __name__ == "__main__":
    ...
    #聚合向量循环大小
    argparser.add_argument("-epochs", type=int, default=300, help="training epochs")
    #轮数
